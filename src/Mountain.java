...
public class Mountain {
    ...
    public Mountain(String filePath) throws FileNotFoundException {
...
//            row++;
        ...
        for(int i=0; i<row; i++){
            ...
            int j=0;
            while(st1.hasMoreTokens()){
                this.points[i][j] = Double.parseDouble(st1.nextToken());
                j++;
            }
    ...
    public boolean isImpossible(double h1, double h2){
